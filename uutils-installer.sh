...
# Only reboot AFTER running this after you remove coreutils with rpm. Remember to addlock coreutils and coreutils-single on zypper.
...
coreutils echo "Only reboot AFTER running this after you remove coreutils with rpm. Remember to zypper addlock coreutils"
